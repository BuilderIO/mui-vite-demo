...
export default function TaskEditDialog({ open, task, onClose, onSubmit, users }: TaskEditDialogProps) {
                      ...
                      secondary={
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 0.5 }}>
                          ...
                          <Typography variant="caption">
                            {entry.changedBy} • {dayjs(entry.timestamp).format('MMM D, YYYY h:mm A')}
                          </Typography>
                        </Box>
                      }
                    />
